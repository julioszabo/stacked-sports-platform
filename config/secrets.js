...
module.exports = {
  ...
  db: process.env.MONGOLAB_URI || process.env.MONGODB || 'mongodb://stackedsports:stackedsports@ds045027.mongolab.com:45027/stacked-sports',
  ...
  instagram: {
    clientID: process.env.INSTAGRAM_ID || 'bc9e6a4375c74d3bbb1f8d509f8d8b9b',
    clientSecret: process.env.INSTAGRAM_SECRET || 'c073b5967b914375980d920fa83f9663',
    callbackURL: '/auth/instagram/callback',
    passReqToCallback: true,
    AccessToken: '1540131109.1fb234f.985c6e11a3fd4cb89dd47cce2b57fbe3'
  },
